            ...
            <DropdownMenu>
              ...
              {(navbarRight.version_string || navbarRight.version_sha) && [
                ...
                <DropdownMenu.ItemGroup key="about-section" title={t('About')}>
                  <DropdownMenu.Item key="imprint">
                    <a href="https://www.fokus.fraunhofer.de/imprint" target="_blank">{t('Imprint')}</a>
                  </DropdownMenu.Item>
                  <DropdownMenu.Item key="privacy">
                    <a href="https://www.fokus.fraunhofer.de/data_protection" target="_blank">{t('Data Privacy')}</a>
                  </DropdownMenu.Item>
